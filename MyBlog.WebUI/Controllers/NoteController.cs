...
namespace MyBlog.WebUI.Controllers
{
    ...
    public class NoteController : Controller
    {
        ...
        public IActionResult GetLiked(int[] ids)
        {
            ...
            return Json(new { Results = likedNoteIds });
        }
        [Auth]
        [HttpPost]
        public IActionResult SetNoteLike(int noteid, bool liked)
        {
            ...
            int result = 0;
            // kullanıcının beğendiği beğendiği/ etkileşime getiirdiği kayıt veritabanında var mı yokmu kontrol edilir.
            ...
            else if (like == null && liked == true)
            {
                ...
                result = _likedManager.Insert(new Liked() {  LikedUserId= CurrentSession.CurrentUser.Id,
                NoteId= noteid });
            }
            ...
            return Json(new { hasError = true, errorMessage = "Beğenilme işlemi gerçekletirilemedi", result = likeCount });
